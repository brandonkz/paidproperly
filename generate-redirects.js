  ...
  <style>
    * {
    ...
    @media (max-width: 540px) {
      body {
        padding: max(12px, env(safe-area-inset-top)) 14px calc(max(72px, env(safe-area-inset-bottom)) + 14px);
      }
...
<body>
  ...
  <div class="container">
    ...
    <div class="progress-container">
      ...
      <div class="countdown">
        Redirecting in <strong id="timer">3</strong> seconds...
      </div>
    </div>
    ...
    <p class="footnote">Verified by PaidProperly • 100% Safe</p>
  </div>
